# Generate final PDF combining all plots for RNA-seq filtered clock analysis
...
message("Generating PDF report for RNA-seq filtered results...")

# Get all PNG files
png_files <- list.files("results/rna/",
  pattern = "\\.png$",
  full.names = TRUE
)
...
# Create PDF
pdf("results/rna/gdc_pancan_rna_methylclock.pdf", width = 15, height = 10)
